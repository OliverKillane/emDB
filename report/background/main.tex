...
\begin{center}
    \includegraphics[scale=1.2]{_drawio/background/images/slow_delta.pdf}
\end{center}

\subsubsection{Complex State}
\begin{center}
    \includegraphics[scale=1.2]{_drawio/background/images/complex_service.pdf}
\end{center}
\subsubsection{Costly Analysis}
\begin{center}
    \includegraphics[scale=1.2]{_drawio/background/images/inefficient_analysis.pdf}
\end{center}
