...
\\
\\ The main outcome of this project is \emdb: an embedded
database compiler wrapped in a procedural macro that generates the code for a 
data store from a schema and queries, and achieves significant performance 
improvements over SQLite and DuckDB on a selection of queries.
\\[2cm]
\centerline{\textbf{Acknowledgements}}
\noindent
I would like to thank my supervisor, Dr. Holger Pirk, for his willingness to
...
College for enabling me to pursue my passion in computer science.
\\
