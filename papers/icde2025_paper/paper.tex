...
% - Using a library developed for the project to produce multiple syntax errors, also produce db multiple semantic errors, pass through useer code to be checked when placed in 
% - No analysis of user code is done by emDB, rust provides an unstable interface for compiling code.
...
% - Row references as a proper par of the language, supported as SQL extensions (in SQLite, not in duckDB)
